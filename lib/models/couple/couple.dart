class Couple {
  ...
  Couple({
    ...
    required this.member1AvatarUrl,
    required this.member1Gender,
    required this.member1DateOfBirth,
    required this.memberId2,
    required this.member2Name,
    required this.member2AvatarUrl,
    required this.member2Gender,
    required this.member2DateOfBirth,
    required this.couplePersonalityTypeId,
    required this.couplePersonalityTypeName,
    required this.couplePersonalityTypeDescription,
    required this.coupleMoodTypeId,
    required this.coupleMoodTypeName,
    required this.coupleMoodTypeDescription,
  });
