...
class ChooseMoodScreenOld extends StatefulWidget {
  const ChooseMoodScreenOld({super.key});

  @override
  State<ChooseMoodScreenOld> createState() => _ChooseMoodScreenState();
}

class _ChooseMoodScreenState extends State<ChooseMoodScreenOld> {
  @override
  void initState() {
    super.initState();
