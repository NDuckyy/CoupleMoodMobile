...
//     try {
//       // Kiểm tra xem user đã login CometChat chưa
//       User? loggedInUser = await _cometChatService.getLoggedInUser();

//       if (loggedInUser == null) {
//         // Lấy cometChatUid từ SharedPreferences
//         final prefs = await SharedPreferences.getInstance();
//         final cometChatUid = prefs.getString('cometChatUid');

//         if (cometChatUid == null || cometChatUid.isEmpty) {
//           // Không có credentials, user cần login trước
//           debugPrint('❌ Không tìm thấy cometChatUid trong SharedPreferences');
//           setState(() => _isLoading = false);
//           return;
//         }

//         // Login với UID từ SharedPreferences
//         debugPrint('🔐 Đang login CometChat với UID: $cometChatUid');
//         loggedInUser = await _cometChatService.loginUser(cometChatUid);
//       }
